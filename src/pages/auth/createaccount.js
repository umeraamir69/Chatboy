...
const Createaccount = ({ providers }) => {
    ...
    const [captchav2, setcaptchav2] = useState(false)
    ...
    const handleSignIn = async (event) => {
        ...
        try {
            ...
            return;
             ...
             // Handle any sign-in errors, display a message
        ...
        return (
            <section>
        <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center  py-5 px-36">
            ...
            <div className="md:flex w-full">
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div className="text-center mb-10">
                        <h1 className="font-bold text-3xl text-gray-900">Join Our Network of Innovators</h1>
                        <p className='mx-10 pt-5'>&quot;Unlock a world of possibilities by creating your account with devXpertize&quot;</p>
                    </div>
                    <form onSubmit={handleSignIn}>
                        <div className="flex -mx-3">
                            <div className="w-1/2 px-3 mb-5">
                                <label htmlFor="fname" className="text-xs font-semibold px-1">First name</label>
                                <div className="flex">
                                    <div className="w-10 capitalize z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input required value={data.fname} onChange={handleChange} name="fname" id="fname" type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John"/>
                                </div>
                            </div>
                            <div className="w-1/2 px-3 mb-5">
                                <label htmlFor="lname" className="text-xs font-semibold px-1">Last name</label>
                                <div className="flex">
                                    <div className="w-10 z-10 pl-1 text-center capitalize pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input required value={data.lname} onChange={handleChange} name = "lname" id="lname" type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith"/>
                                </div>
                            </div>
                        </div>
                        <div className="flex -mx-3">
                            <div className="w-full px-3 mb-5">
                                ...
                                <div className="flex">
                                    ...
                                    <input type="email" id="email" onChange={handleChange} value={data.email}  name="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com"/>
                                </div>
                            </div>
                        </div>
                ...
                <p className="px-3 text-sm dark:text-gray-400">Create Account with Social accounts</p>
                <div className="flex-1 h-px sm:w-16 bg-gray-700"></div>
                        ...
                        {providerval ? 
                <div className="flex justify-center space-x-4" key={providerval[1].name}>
                    <button aria-label="Log in with Google" className="p-3 rounded-sm" onClick={() => signIn(providerval[1].id)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                            <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
                        </svg>
                    </button>

                    <button aria-label="Log in with GitHub" className="p-3 rounded-sm"  key={providerval[0].name}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current"  onClick={() => signIn(providerval[0].id)}>
