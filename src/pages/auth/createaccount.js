            ...
            <div className="md:flex w-full">
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div className="text-center mb-10">
                        <h1 className="font-bold text-3xl text-gray-900">Join Our Chat Boyt</h1>
                        <p className='mx-10 pt-5'>&quot;Unlock a world of possibilities by creating your account with chatboy&quot;</p>
                    </div>
