                            ...
                            <form onSubmit={handleSignIn}>
                                <div className="flex -mx-3">
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 capitalize z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                    ...
                                    <div className="w-1/2 px-3 mb-5">
                                        ...
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center capitalize pointer-events-none flex items-center justify-center">
                                                <i className="mdi mdi-account-outline text-gray-400 text-lg"></i>
                                            </div>
                                            <input 
                                                required 
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <label htmlFor="dateOfBirth" className="text-xs font-semibold px-1">Date of Birth</label>
                                        <div className="flex">
                                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i className="mdi mdi-calendar-text-outline text-gray-400 text-lg"></i>
                                            </div>
                                            <input 
                                                required 
                                                type="date" 
                            ...
                            {providerval ? 
                                <div className="flex justify-center space-x-4" key={providerval[1].name}>
                                    <button 
                                        ...
                                        onClick={() => signIn(providerval[1].id)}
                                    >
                                        {/* Google SVG */}
